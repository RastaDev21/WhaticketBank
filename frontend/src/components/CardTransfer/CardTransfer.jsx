...
export default function CardTransfer({ isTransferPage = false }) {
  return (
    <Card
      sx={{
        width: "151px",
        height: "131px",
        borderRadius: "10px",
        background: isTransferPage ? "#3956FF" : "#FFF", // Alteração do fundo conforme a prop
        boxShadow: "0px 0px 23px -1px rgba(0, 0, 0, 0.10)", // Sombras
        padding: "20px",
        display: "flex",
    ...
    >
      ...
      >
        ...
        >
          {/* SVG do círculo (fundo branco ou azul) */}
          <svg
          ...
          >
            <circle
              ...
              cy="35.5"
              r="35.5"
              fill={isTransferPage ? "white" : "#3956FF"} // Cor do círculo conforme fundo
            />
          </svg>
          ...
          <svg
            ...
            fill="none"
          >
            <g clipPath="url(#clip0_9014_3527)">
              {isTransferPage ? (
                <>
                  {/* SVG do ícone com fundo azul e bolinhas brancas */}
                  <path
                ...
                <>
                  {/* SVG do ícone com fundo branco e bolinhas azuis */}
                  <path
        ...
        <Typography
          ...
          sx={{
            marginTop: "8px",
            color: isTransferPage ? "#FFF" : "#7A7A80", // Cor do texto dependendo do fundo
            textAlign: "center",
