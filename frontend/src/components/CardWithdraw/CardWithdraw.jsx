...
export default function CardWithdraw({ isWithdrawPage = false }) {
  return (
    <Card
      sx={{
        width: "151px",
        height: "131px",
        borderRadius: "10px",
        background: isWithdrawPage ? "#3956FF" : "#FFF",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <circle
              ...
              cy="35.5"
              r="35.5"
              fill={isWithdrawPage ? "#FFF" : "#3956FF"}
            />
          </svg>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <g clipPath="url(#clip0_9010_2332)">
              <path
                ...
                fill={isWithdrawPage ? "#3956FF" : "white"}
              />
              <path
                ...
                fill={isWithdrawPage ? "#3956FF" : "white"}
                stroke={isWithdrawPage ? "white" : "#3956FF"}
              />
            </g>
            <defs>
        ...
        <Typography
          ...
          sx={{
            marginTop: "8px",
            color: isWithdrawPage ? "#FFF" : "#7A7A80",
            textAlign: "center",
